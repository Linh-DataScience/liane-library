...
# --- IMPROVED LOAN PAGE WITH DATES ---
elif page == "Active Loan":
    st.title("🤝 Create a Loan")
    ...
    with st.form("loan_form"):
        ...
        # We calculate the dates here
        today = date.today()
        return_date = today + timedelta(days=14) # Standard: 14 days
        
        st.write(f"📅 **Borrow Date:** {today}")
        st.write(f"⏰ **Scheduled Return:** {return_date}")
